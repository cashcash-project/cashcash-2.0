...
#include "qt/cashcash/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(cashcashGUI* _window, QWidget *parent) :
