...
#include "qt/cashcash/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(cashcashGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("cashcash_tx_csv_export(*.csv)") : tr("cashcash_addresses_csv_export(*.csv)"),
                                        nullptr);
