...
#include "qt/cashcash/settings/settingsbackupwallet.h"
#include "qt/cashcash/settings/settingsexportcsv.h"
#include "qt/cashcash/settings/settingsbittoolwidget.h"
#include "qt/cashcash/settings/settingssignmessagewidgets.h"
#include "qt/cashcash/settings/settingswalletrepairwidget.h"
#include "qt/cashcash/settings/settingswalletoptionswidget.h"
#include "qt/cashcash/settings/settingsmainoptionswidget.h"
#include "qt/cashcash/settings/settingsdisplayoptionswidget.h"
#include "qt/cashcash/settings/settingsmultisendwidget.h"
#include "qt/cashcash/settings/settingsinformationwidget.h"
#include "qt/cashcash/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(cashcashGUI* parent);
    ~SettingsWidget();
