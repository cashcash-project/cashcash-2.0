...
#include "qt/cashcash/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cashcash/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(cashcashGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to cashcashGUI::handleRestart()
