...
#include "qt/cashcash/settings/settingsnetworkwidget.h"
#include "qt/cashcash/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/cashcash/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(cashcashGUI* _window, QWidget *parent) :
