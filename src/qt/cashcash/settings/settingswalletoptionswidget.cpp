...
#include "qt/cashcash/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cashcash/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(cashcashGUI* _window, QWidget *parent) :
