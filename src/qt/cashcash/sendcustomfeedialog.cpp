...
#include "qt/cashcash/sendcustomfeedialog.h"
#include "qt/cashcash/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(cashcashGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &cashcashGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
