...
#include "qt/cashcash/forms/ui_topbar.h"
#include "qt/cashcash/lockunlock.h"
#include "qt/cashcash/qtutils.h"
#include "qt/cashcash/receivedialog.h"
#include "qt/cashcash/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/cashcash/balancebubble.h"
...
TopBar::TopBar(cashcashGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("cashcash")
    updateDisplayUnit();
