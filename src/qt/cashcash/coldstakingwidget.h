...
#include "qt/cashcash/furabstractlistitemdelegate.h"
#include "qt/cashcash/txviewholder.h"
#include "qt/cashcash/tooltipmenu.h"
#include "qt/cashcash/sendmultirow.h"
#include "qt/cashcash/coldstakingmodel.h"
#include "qt/cashcash/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(cashcashGUI* parent);
    ~ColdStakingWidget();
