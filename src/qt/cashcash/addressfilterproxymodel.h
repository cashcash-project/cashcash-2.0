...
#ifndef cashcash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define cashcash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //cashcash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
