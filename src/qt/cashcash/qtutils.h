...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, cashcashGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, cashcashGUI* gui, double posX = 3);
