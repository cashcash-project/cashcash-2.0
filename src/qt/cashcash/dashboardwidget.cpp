...
#include "qt/cashcash/forms/ui_dashboardwidget.h"
#include "qt/cashcash/sendconfirmdialog.h"
#include "qt/cashcash/txrow.h"
...
DashboardWidget::DashboardWidget(cashcashGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &cashcashGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
