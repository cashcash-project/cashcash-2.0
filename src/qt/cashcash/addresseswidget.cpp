...
#include "qt/cashcash/forms/ui_addresseswidget.h"
#include "qt/cashcash/addresslabelrow.h"
#include "qt/cashcash/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(cashcashGUI* parent) :
    PWidget(parent),
