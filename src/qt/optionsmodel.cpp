...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizecashcashAmount") || reset)
        gArgs.SoftSetArg("-anonymizecashcashamount", settings.value("nAnonymizecashcashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cashcash.cpp during shotdown to also remove the window positions
