...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            cashcashGUI* window = static_cast<cashcashGUI*>(parentWidget());
...
{
    cashcashGUI* gui = static_cast<cashcashGUI*>(parentWidget());
...
{
    hide();
    static_cast<cashcashGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("cashcash will close now to finish the encryption process. "
