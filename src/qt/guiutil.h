...
/** Utility functions used by the cashcash Qt UI.
 */
namespace GUIUtil
{
...
// Render cashcash addresses in monospace font
...
// Parse "cashcash:" URI into recipient object, return true on successful parsing
