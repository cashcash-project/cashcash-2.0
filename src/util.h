...
extern const char * const cashcash_CONF_FILENAME;
extern const char * const cashcash_PID_FILENAME;
extern const char * const cashcash_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("cashcash-%s", name);
