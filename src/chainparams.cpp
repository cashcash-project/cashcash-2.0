...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    ...
    {2365700, uint256S("b5d0beead57735539abc2db2b0b08cd65db3e5928efd3c3bf3182d5bf013f36c")}, //!< cashcash v4.1.1 enforced
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // cashcash starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.ncashcashBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.ncashcashBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "cashcash.seed.fuzzbawls.pw", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("fuzzbawls.pw", "cashcash.seed2.fuzzbawls.pw", true);    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "cashcash-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("fuzzbawls.pw", "cashcash-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cashcash addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cashcash script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cashcash BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet cashcash BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet cashcash BIP44 coin type is '1' (All coin's testnet default)
