...
// Copyright (c) 2016-2020 The cashcash developers
...
public:
    ...
    /**
     * Amount of cashcash coming in to a transaction
...
// cashcash: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
