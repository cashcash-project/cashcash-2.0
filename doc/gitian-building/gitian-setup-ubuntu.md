...
The build script we'll be using is contained in the cashcash github repository ([contrib/gitian-build.py](https://github.com/cashcash-project/cashcash/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the cashcash repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/cashcash-project/cashcash/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cashcash-detached-sigs, and cashcash GitHub repos.
