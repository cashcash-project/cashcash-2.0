...
The script [extract-osx-sdk.sh](https://github.com/cashcash-project/cashcash/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cashcash/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/cashcash-project/cashcash/blob/master/doc/README_osx.md) for troubleshooting tips.