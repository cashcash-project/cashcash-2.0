cashcash Core version *3.3.0* is now available from:  <https://github.com/cashcash-project/cashcash/releases>
...
The `masternode` and `mnbudget` RPC commands, which were marked as deprecated in cashcash Core v2.3.1 (September 19, 2017), have now been completely removed from cashcash Core.

Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://github.com/cashcash-Project/cashcash/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.
