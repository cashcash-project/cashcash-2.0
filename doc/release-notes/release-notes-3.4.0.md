cashcash Core version *3.4.0* is now available from:  <https://github.com/cashcash-project/cashcash/releases>
...
cashcash Core v3.4.0 is a mandatory update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
