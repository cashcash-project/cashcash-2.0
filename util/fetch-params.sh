...
Failed to fetch the cashcash zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
cashcash - fetch-params.sh

This script will fetch the cashcash zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common cashcash zkSNARK parameters. Note that it is
