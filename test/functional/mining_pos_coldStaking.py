...
from test_framework.cashcash_node import cashcashTestNode
...
class cashcash_ColdStakingTest(cashcashTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(cashcashTestNode())
