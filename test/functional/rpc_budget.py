...
class BudgetProposalTest(cashcashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid cashcash address")
        assert_raises_rpc_error(-5, "Invalid cashcash address", self.nodes[0].preparebudget,
